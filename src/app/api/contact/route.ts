  ...
  try {
    ...
    <head>
      ...
      <style>
        ...
        .field-value { font-size: 16px; color: #ffffff; font-weight: 400; line-height: 1.6; white-space: pre-wrap; }
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <h2 style="color: #ffffff; margin: 0; font-size: 14px; font-weight: 300; letter-spacing: 3px; text-transform: uppercase;">New Consultation Request</h2>
        </div>
        <div class="content">
          <div class="greeting">You have received a new consultation inquiry from the website.</div>
          ...
          <div class="field">
            <div class="field-label">Legal Domain / Matter Type</div>
            <div class="field-value">${legal_domain}</div>
          </div>
          
          <div class="field">
            <div class="field-label">Brief Matter Summary</div>
            <div class="field-value">${message}</div>
          </div>
        </div>
        <div class="footer">
          This email was automatically generated from the Prime Law Bharat website contact form.
        </div>
      </div>
    </body>
    </html>
